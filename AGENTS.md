...
Changes to packaging or `cto-run` require validation in both Codex and Claude Code. Support claims require fresh evidence for the exact final state being claimed.
