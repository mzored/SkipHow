...
| [Field audit](field-audit-2026-08-26.md) ([coverage sidecar](field-audit-2026-08-26.receipts.json)) | The first audit of real sessions in other repositories: references that never loaded, merges without a grant, the first 1.7.0 field receipt, and one fifteen-item request worked entirely in one agent. Its migrated sidecar preserves the four historical snapshot keys but cannot establish freshness because fingerprints were not frozen at the time |
