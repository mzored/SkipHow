...
| [Field audit](field-audit-2026-08-26.md) | The first audit of real sessions in other repositories: references that never loaded, merges without a grant, the first 1.7.0 field receipt, and one fifteen-item request worked entirely in one agent |
