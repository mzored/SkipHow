...
A policy edit — a sentence tightened, moved to an earlier package surface, or deleted because it contradicted another — is recorded by its changelog section and by the field-audit receipt that motivated it. When such an edit answers a question an ADR already owns, amend that ADR; do not open a competing one. [ADR 0018](0018-autonomous-kernel-and-independent-task-skills.md) carries the current authority and record boundary.
...
| [0010](0010-two-matcher-hook-and-codex-project-loading.md) | One hook with two matcher groups; Codex evidence through project-level loading | Both continuity matcher groups and receipt policy stand; 1.x project-loading workaround superseded by 0018 |
...
| [0018](0018-autonomous-kernel-and-independent-task-skills.md) | Use one autonomous owner skill with focused internal methods | Accepted for 2.0.1 |
