...
This directory records accepted SkipHow architecture decisions. [How it works](../how-it-works.md) describes the current design. The [2026-08-26 research](../research/2026-08-26/README.md) records the 1.0 to 1.2 release evidence. The [2026-08-25 research](../research/2026-08-25/README.md) records the host-native rewrite that preceded it.
...
| [0007](0007-host-adapters-for-routing-and-continuity.md) | Resolve model tiers and session continuity in host adapters | Accepted, amended by 0009 |
