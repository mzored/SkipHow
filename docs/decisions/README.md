...
This directory records accepted SkipHow architecture decisions. [How it works](../how-it-works.md) describes the current design. The [2026-08-26 research](../research/2026-08-26/README.md) records the 1.0 to 1.3 release evidence. The [2026-08-25 research](../research/2026-08-25/README.md) records the host-native rewrite that preceded it.
...
| [0010](0010-two-matcher-hook-and-codex-project-loading.md) | One hook with two matcher groups; Codex evidence through project-level loading | Accepted |
