...
This directory records accepted SkipHow architecture decisions. [Architecture](../architecture.md) describes the target accepted for Issue #15. The dated [research](../research/2026-08-25/README.md) records the evidence behind these decisions.
