...
| [Superpowers](https://github.com/obra/superpowers) | Isolated review, bounded repair, concise handoffs | Mandatory brainstorming, approval gates, and test-first development |
| [Matt Pocock skills](https://github.com/mattpocock/skills) | Progressive disclosure, repro-first diagnosis, research before building, triage and findings | Manual skill chaining and loading the whole library |
