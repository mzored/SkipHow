...
- Deterministic checks pass (47 tests). The root is 983 words of 1,000 and 6352 bytes of 7,000; the largest reference is `model-routing.md` at 599 of 600, `long-work.md` next at 596, and the references total 3898 of 4,000. Claude package validation and Claude isolated install pass locally; Codex package validation and Codex isolated install are `UNVERIFIED` here, as this machine's managed Codex policy rejects the local marketplace.
