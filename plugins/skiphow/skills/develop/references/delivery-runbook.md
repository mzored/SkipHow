...
The campaign is complete only when every included item is implemented, independently reviewed where policy requires it, verified against its acceptance criteria, integrated into the target, and reconciled with the canonical tracker. No executable lane or unaccounted mutable state may remain.
