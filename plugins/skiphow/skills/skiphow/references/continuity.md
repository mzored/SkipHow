...
Prefer the host's native continuation state when it can carry the work. Use `.skiphow/handoff.md` only when the project needs a durable local checkpoint and the request authorizes that record.
