...
- `journal.jsonl`
- `briefing.md`
- `decisions/` when an ADR is created
- `evidence/` when raw evidence is stored
- `receipts/` when a worker or conditional acceptance receipt is stored
- `FINAL.md`, generated from reconciled state at completion
