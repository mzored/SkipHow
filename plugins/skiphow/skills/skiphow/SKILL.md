...
Before dispatching a delegate, read [delegation](references/delegation.md). It settles the brief, the lanes, the isolation, and the level each delegate runs at. A roster line is a trigger you have to notice; this is the act itself.
