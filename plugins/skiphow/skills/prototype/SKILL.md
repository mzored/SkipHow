...
Use this capability only when the unknown is the desired interaction or state model. Unknown causes belong to `../diagnose/SKILL.md`; known behavior with an uncertain implementation remains a CTO engineering decision.
